...
## <h2 align="center">Flatiron School Projects</h2>
  - **"JustRight"** - A single page React app that provides parents top quality services such as tutoring and babysitting.<br>
  ...
  - **"FlashLight"** - A game in which a player holds a flashlight to scare away zombies while collecting Ruby gems!<br>
  [FrontEnd](https://github.com/Adubz97/game-project-front-end) || [BackEnd](https://github.com/Adubz97/game-project-back-end) || [Demo](https://youtu.be/hvUnfy2FNpA)
